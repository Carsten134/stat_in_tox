...
## Exercise 22
implementation of the bicluster consists a couple of functions first one is $H_Y$ for a given matrix:
```{r}
...
```
Next we want to implement the biclustering algorithm for one cluster next.
```{r}
